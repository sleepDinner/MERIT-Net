...
class LightweightDecoder(nn.Module):
    ...
    def forward(self, features: List[torch.Tensor], input_size: Tuple[int, int]) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
        ...
        return coarse_full, fused_feature, coarse_low
